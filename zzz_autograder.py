...
random.seed(0)
try: 
    from zzz_pacman import GameState
except:
    pass
...
def runTest(testName, moduleDict, printTestCase=False, display=None):
    ...
    grades = zzz_grading.Grades(projectParams.PROJECT_NAME, [(None,0)])
...
def evaluate(generateSolutions, testRoot, moduleDict, exceptionMap=ERROR_HINT_MAP,
    ...
    grades = zzz_grading.Grades(projectParams.PROJECT_NAME, questions,
...
def getDisplay(graphicsByDefault, options=None):
    ...
    if graphics:
        try:
            ...
            return zzz_graphicsDisplay.PacmanGraphics(1, frameTime=.05)
        except ImportError:
            pass
    import textDisplay
