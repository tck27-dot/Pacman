...
from food import PacmanFoodSearchSpace
from heuristics import food_heuristic
...
from zzz_game import Directions
from zzz_game import Agent
from zzz_game import Actions
import zzz_util
import time
import search
...
class SearchAgent(Agent):
    ...
    def __init__(
        ...
        if "heuristic" not in func.__code__.co_varnames:
            print("searching using function " + fn)
...
class PositionSearchProblem(search.SearchSpace):
    """
...
def convert_original_game_state(state):
...
class CornersProblem(search.SearchSpace):

    def __init__(self, startingGameState):
        state = convert_original_game_state(startingGameState)        
        self.walls = startingGameState.getWalls()
        self.startingPosition = startingGameState.getPacmanPosition()
        self.state_space = PacmanCornersSearchSpace(state)

    def get_start_state(self):
        return self.state_space.get_start_state()

    def is_final_state(self, state):
        return self.state_space.is_final_state(state)

    def get_successors(self, state):
        return self.state_space.get_successors(state)
...
def cornersHeuristic(state, problem):
    ...
    """
    return corners_heuristic(state, problem.state_space)
...
class FoodSearchProblem:
    ...
    def __init__(self, startingGameState):
        ...
        self.walls = startingGameState.getWalls()
        self.startingPosition = startingGameState.getPacmanPosition()
        self.state_space = PacmanFoodSearchSpace(state)
...
def foodHeuristic(state, problem):
    return food_heuristic(state, problem.state_space)
